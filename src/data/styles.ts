    ...
    subStyles: [
      {
        ...
        ingredients: "Debittered roast malts such as Carafa Special or Midnight Wheat for color without harsh roast. American or New World hops.",
        tags: ["high-strength", "dark-color", "top-fermented", "north-america", "craft-style", "ipa-family", "bitter", "hoppy"],
      },
      {
        name: "Belgian IPA",
        overallImpression: "An IPA with the fruitiness and spiciness derived from the use of Belgian yeast strains. Hop character is similar to an American IPA but married with Belgian yeast character.",
        vitalStats: {
          ogMin: 1.058, ogMax: 1.08,
          fgMin: 1.008, fgMax: 1.016,
          ibuMin: 50, ibuMax: 70,
          srmMin: 5, srmMax: 8,
          abvMin: 6.2, abvMax: 9.5,
        },
        ingredients: "Belgian yeast strains used in conjunction with American hop varieties. Pilsner or pale base malt with Belgian candy sugar sometimes used.",
        tags: ["high-strength", "pale-color", "top-fermented", "north-america", "craft-style", "ipa-family", "bitter", "hoppy"],
      },
      {
        name: "Brown IPA",
        overallImpression: "A hoppy, bitter, and moderately strong American pale ale with a malty, toasty, or dark caramel character from dark crystal or specialty malts.",
        vitalStats: {
          ogMin: 1.056, ogMax: 1.07,
          fgMin: 1.008, fgMax: 1.016,
          ibuMin: 40, ibuMax: 70,
        ...
        ingredients: "Crystal and chocolate malts for color and nutty-toasty character. American or New World hops.",
        tags: ["high-strength", "dark-color", "top-fermented", "north-america", "craft-style", "ipa-family", "bitter", "hoppy"],
      },
      {
        name: "Red IPA",
        overallImpression: "A hoppy, bitter, and moderately strong American ale with a caramel-malty backbone. The red color comes from crystal malts.",
        vitalStats: {
          ogMin: 1.056, ogMax: 1.07,
          fgMin: 1.008, fgMax: 1.016,
          ibuMin: 40, ibuMax: 70,
        ...
        ingredients: "Crystal malts for color and caramel character. American or New World hops.",
        tags: ["high-strength", "amber-color", "top-fermented", "north-america", "craft-style", "ipa-family", "bitter", "hoppy"],
      },
      {
        name: "Rye IPA",
        overallImpression: "A moderately strong American ale with a dry, spicy rye character. Rye malt adds spiciness and a distinctive dry finish.",
        vitalStats: {
          ogMin: 1.056, ogMax: 1.075,
          fgMin: 1.008, fgMax: 1.014,
          ibuMin: 50, ibuMax: 75,
        ...
        ingredients: "Rye malt (15-20% of grist) providing spicy, dry character. American or New World hops.",
        tags: ["high-strength", "amber-color", "top-fermented", "north-america", "craft-style", "ipa-family", "bitter", "hoppy"],
      },
      {
        name: "White IPA",
        overallImpression: "A fruity, spicy, refreshing version of an American IPA with a lighter mouthfeel, a wheat base, and a Belgian-inspired yeast or spice character.",
        vitalStats: {
          ogMin: 1.056, ogMax: 1.065,
          fgMin: 1.01, fgMax: 1.016,
          ibuMin: 40, ibuMax: 70,
          srmMin: 5, srmMax: 8,
          abvMin: 5.5, abvMax: 7,
        },
        ingredients: "Wheat malt (30-40% of grist) for body and haze. Citrusy American hops. Belgian witbier yeast or coriander/orange peel.",
        tags: ["high-strength", "pale-color", "top-fermented", "north-america", "craft-style", "ipa-family", "wheat-beer-family", "bitter", "hoppy"],
      },
    ],
  },
  {
